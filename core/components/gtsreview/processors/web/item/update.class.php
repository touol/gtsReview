...
class gtsReviewOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('gtsreview_item_err_ns');
        }
...
return 'gtsReviewOfficeItemUpdateProcessor';
