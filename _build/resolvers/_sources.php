...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'gtsReview',
                'description' => 'Default source for files of gtsReview',
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'gtsreview_source_default'))) {
